...
public class AdapterListWithImage extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (activityName.equals(ActivityBranches)) {
			holder.itemImage.setImageResource(R.mipmap.superheading1);
		...
		if (activityName.equals(Activityoutlets)) {
			...
			if (searchArrayList.get(position).getTitle().equals("Supermarkets")) {
				holder.itemImage.setImageResource(R.mipmap.branchheader);
			}

			if (searchArrayList.get(position).getTitle().equals("Wholesalers")) {
				holder.itemImage.setImageResource(R.mipmap.wholesale);
			}

		}

		if (activityName.equals(ActivityListBrands)) {
			holder.itemImage.setImageResource(R.mipmap.ic_shop);
		...
		if (activityName.equals(ActivityAisle)) {
			if (searchArrayList.get(position).getTitle()
				...
				holder.itemImage.setImageResource(R.mipmap.specialoffer);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Bread & Bakery")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_bread);
			}
			if (searchArrayList.get(position).getTitle().equals("Dairy & Eggs")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_dairy);
			...
			if (searchArrayList.get(position).getTitle().equals("Fruits")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_fruits);
			}
			if (searchArrayList.get(position).getTitle().equals("Baby Care")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_babycare);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Frozen Food & Ice Cream")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_ice);
			}
			if (searchArrayList.get(position).getTitle().equals("Seafood")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_seafood);
			}
			if (searchArrayList.get(position).getTitle().equals("Vegetables")) {
				holder.itemImage
						.setImageResource(R.mipmap.grocery_vegetables);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Canned & Jarred Foods")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_canned);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Cooking Oil & Fat")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_oil);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Confectionery")) {
				holder.itemImage
						.setImageResource(R.mipmap.grocery_confectionaries);
			}
			if (searchArrayList.get(position).getTitle().equals("Home Care")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_homecare);
			}
			if (searchArrayList.get(position).getTitle().equals("Seasoning")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_seasoning);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Cereals & Breakfast Food")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_cereals);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Processed Foods")) {
				holder.itemImage
						.setImageResource(R.mipmap.grocery_processedfood);
			}
			if (searchArrayList.get(position).getTitle()
					.equals("Personal Care")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_bodycare);
			}
			if (searchArrayList.get(position).getTitle().equals("Meat")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_meat);
			}
			if (searchArrayList.get(position).getTitle().equals("Deli")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_deli);
			}
			if (searchArrayList.get(position).getTitle().equals("Medicare")) {
				holder.itemImage.setImageResource(R.mipmap.grocery_medicare);
			}
		}
