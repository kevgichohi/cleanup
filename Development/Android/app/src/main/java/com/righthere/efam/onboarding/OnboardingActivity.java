package com.righthere.efam.onboarding;
...
import com.righthere.efam.ActivityMain;
...
public class OnboardingActivity extends AppCompatActivity {
    ...
    private void addBottomDots(int currentPage) {
      ...
      // int colorsActive = getResources().getInteger(R.color.yellow);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(OnboardingActivity.this, ActivityMain.class));
        finish();
    }
