...
public class AdapterMyPastREReceipt extends BaseAdapter {
	...
	public AdapterMyPastREReceipt(Context ctx,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.reorderreceiptpast, null);
