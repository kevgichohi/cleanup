...
public class AdapterProductscart extends BaseAdapter implements
	...
	public AdapterProductscart(Context ctx,
			ArrayList<RequestedResults> results, TextView cartBtnNotification,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.itemtotalprice1 = (TextView) convertView
					.findViewById(R.id.itemtotalprice);

			// holder.itemtotalprice1.setVisibility(View.GONE);
		...
		holder.itemtotalprice1.setText("KES. " + item_total);
		...
		if (itemId.equals("0")) {
			...
			if (unitsInCart != null && !unitsInCart.equals(0)) {
				holder.addtocart.setText("+"
						+ searchArrayList.get(position).getUnits());
	...
	public void onClick(View v) {
		...
		Button removefromcart = (Button) parentRow
				.findViewById(R.id.removefromcart);
