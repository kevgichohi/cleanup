...
public class ActivityStep10ListPaymentOptions<NameValuePair> extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (sharedPreferences.contains("loggedIn")
			...
			helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
					...
					ActivityStep10ListPaymentOptions.this, sharedPreferences);
			...
			Intent intent = new Intent(ActivityStep10ListPaymentOptions.this,
	...
	private class ApplyViewParamsTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String params) {
			...
			optionPayCash.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					editor.putString("paymentOption", "Cash").commit();
					Intent intent = new Intent(
							ActivityStep10ListPaymentOptions.this,
							ActivityStep11MyReceipt.class);
					startActivity(intent);
				}
			});

			optionPayOnline.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
