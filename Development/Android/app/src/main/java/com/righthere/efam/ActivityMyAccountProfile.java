...
public class ActivityMyAccountProfile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editCustomerInfo = (Button) findViewById(R.id.editCustomerInfo);
		...
		headerTextimage2.setImageResource(R.mipmap.infoheader);
		...
		helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
				cartButtonNotification, ActivityMyAccountProfile.this,
				sharedPreferences);
		...
		clearcart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (sharedPreferences.contains("myTrolley")) {
					...
					Toast.makeText(ActivityMyAccountProfile.this,
		...
		if (sharedPreferences.contains("loggedIn")) {
			...
			// ((TextView)customerGender.getChildAt(0)).setTextColor(color.grey666);
			// ((TextView)customerGender.getChildAt(0)).setTextColor(color.grey666);
			...
			Intent intent = new Intent(ActivityMyAccountProfile.this,
	...
	public <ViewGroup> void spinner2meth() {
...

		{
			public View getView(int position, View convertView,
				...
				tfavv = Typeface.createFromAsset(getAssets(),
						"fonts/ek_mukta/EkMukta-ExtraLight.ttf");
		...
		// customerGender.setSelection(((ArrayAdapter<String>)customerGender.getAdapter()).getPosition(getString(0)));
	}

	public void SetSpinnerSelection(Spinner customerGender, String[] array,
			String text) {
		for (int i = 0; i < array.length; i++) {
			if (array[i].equals(text)) {
				customerGender.setSelection(i);
			}
		}
	}
	...
	private class ApplyViewParamsTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String params) {
			...
			editCustomerInfo.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
				...
				for (int i = 0; i < jsonArr.length(); i++) {
					...
					if (querytype.equals("insert info")) {
						...
						if (customerInfo.equals("0")) {
							...
							String user_id = customerInfoObj
									.getString("id");
							...
							customerGender
									.setSelection(((ArrayAdapter<String>) customerGender
											.getAdapter())
