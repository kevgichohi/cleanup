...
public class ActivityStep08ListCart extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myadapter = new AdapterMyCart(ActivityStep08ListCart.this, MYCART,
	...
	private void initViews() {
		...
		headerTextimage2.setImageResource(R.mipmap.outlets);

		// LOAD QUICKLINKS
		HelperQuickLinks helperQuickLinks = new HelperQuickLinks();
		helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
				cartButtonNotification, ActivityStep08ListCart.this,
				sharedPreferences);
		...
		backToAisles.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(ActivityStep08ListCart.this,
	...
	private class populateListViewTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String params) {
			...
			// /editor.putString("reorder", "").commit();
