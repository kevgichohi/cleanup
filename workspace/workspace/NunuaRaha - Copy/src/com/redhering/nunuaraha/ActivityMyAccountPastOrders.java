...
public class ActivityMyAccountPastOrders extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	queryThree = (TextView) findViewById(R.id.queryThree);
  		...
  		helperQuickLinks.create(menuIcon,shoppingButton,cartButton,cartButtonNotification,ActivityMyAccountPastOrders.this,sharedPreferences);
	    ...
	    //SET TEXT, APPLY FONTS, SETONCLICKLISTENERS
  		...
  		if(sharedPreferences.contains("userPhoneNumber")) {
            ...
            new HttpAsyncTask().execute("http://www.smokesignal.co.ke/mobile_trolley_app/getmypastorders.php");
            
            //LIST VIEW
      		MYORDERS = new ArrayList<RequestedSimpleListOrders>();
    		myadapter = new AdapterListPastOrders(ActivityMyAccountPastOrders.this, MYORDERS,layout_progressbar,ratingForm);
    		...
    		listView.setOnItemClickListener(new OnItemClickListener() {
    			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    			    ...
    			    Intent intent = new Intent(ActivityMyAccountPastOrders.this, ActivityStep09ListDeliveryOptions.class);
    	    	    startActivity(intent);
    			}
    		});
  		}else{
  			Intent intent = new Intent(ActivityMyAccountPastOrders.this, ActivityMyAccountLogin.class);
	...
	private class ApplyViewParamsTask extends AsyncTask<String, Void, String> {
	    ...
	    protected void onPostExecute(String params) {
	  		...
	  		cancelRatingButton.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	            	//Reload page
	            	startActivity(new Intent(ActivityMyAccountPastOrders.this, ActivityMyAccountPastOrders.class));
	            }
	        });
