...
public class AdapterListOrders_Copy extends BaseAdapter implements android.view.View.OnClickListener {
    ...
    public AdapterListOrders_Copy(Context ctx, ArrayList<RequestedSimpleListOrders> results, LinearLayout layout_loading, RelativeLayout rateForm) {
