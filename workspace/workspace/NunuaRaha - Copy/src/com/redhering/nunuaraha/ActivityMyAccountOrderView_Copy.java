...
public class ActivityMyAccountOrderView_Copy extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ORDER_AMOUNT = extras.getString("orderAmount");
  		...
  		helperQuickLinks.create(menuIcon,shoppingButton,cartButton,cartButtonNotification,ActivityMyAccountOrderView_Copy.this,sharedPreferences);
		...
		myadapter = new AdapterListOrders(ActivityMyAccountOrderView_Copy.this, MYORDERS, layout_progressbar,ratingForm);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			    ...
			    Intent intent = new Intent(ActivityMyAccountOrderView_Copy.this, ActivityStep09ListDeliveryOptions.class);
