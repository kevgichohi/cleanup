...
public class AdapterListOrders extends BaseAdapter implements android.view.View.OnClickListener {
    ...
    public AdapterListOrders(Context ctx, ArrayList<RequestedSimpleListOrders> results, LinearLayout layout_loading, RelativeLayout rateForm) {
