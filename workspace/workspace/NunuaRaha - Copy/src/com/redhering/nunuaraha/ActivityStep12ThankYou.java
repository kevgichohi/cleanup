...
public class ActivityStep12ThankYou extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Transaction_type = sharedPreferences.getString("transactionType", null);
	...
	private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
		        ...
		        sharedPreferences.edit().remove("transactionType").commit();
	...
	public static String GET(String url){
        ...
        nameValuePairs.add(new BasicNameValuePair("customer_order_total",TOTAL));
        ...
        nameValuePairs.add(new BasicNameValuePair("payment_pref",Transaction_type));
