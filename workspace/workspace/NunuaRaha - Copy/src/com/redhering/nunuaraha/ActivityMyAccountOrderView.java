...
public class ActivityMyAccountOrderView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        MYRECEIPT = new ArrayList<RequestedResultsReceipt>();
  		myadapterreceipt = new AdapterMyReceipt(ActivityMyAccountOrderView.this, MYRECEIPT);
	    ...
	    protected void onPostExecute(String params) {
			...
			reOrder.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	            	//Intent intent = new Intent(ActivityMyAccountOrderView.this, ActivityStep12ThankYou.class);
