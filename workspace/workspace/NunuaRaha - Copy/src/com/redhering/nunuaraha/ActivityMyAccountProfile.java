...
public class ActivityMyAccountProfile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		headerTextimage2.setImageResource(R.drawable.activeinfo);
  		...
  		if(sharedPreferences.contains("loggedIn") ) {
	       ...
	       spinner2meth(); 
    		...
    		new ApplyViewParamsTask().execute();
  			...
  			Intent intent = new Intent(ActivityMyAccountProfile.this, ActivityMyAccountLogin.class);
	...
	private class ApplyViewParamsTask extends AsyncTask<String, Void, String> {
	    ...
	    protected void onPostExecute(String params) {
			layout_progressbar.setVisibility(View.GONE);
	  		headerText.setText("My Information");
						...
						if(customerInfo.equals("0")){
							...
							if(getIntent().hasExtra("from")) {
								...
								try {
			            			...
			            			Intent intent = new Intent(ActivityMyAccountProfile.this, callerClass);
						    	    startActivity(intent);
