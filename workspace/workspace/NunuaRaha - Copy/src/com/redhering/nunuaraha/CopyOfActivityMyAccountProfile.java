...
public class CopyOfActivityMyAccountProfile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		customerDOB = (TextView) findViewById(R.id.customerDOB);
  		...
  		helperQuickLinks.create(menuIcon,shoppingButton,cartButton,cartButtonNotification,CopyOfActivityMyAccountProfile.this,sharedPreferences);
  		...
  		if(sharedPreferences.contains("loggedIn") ) {
    		...
    		new ApplyViewParamsTask().execute();
  			...
  			Intent intent = new Intent(CopyOfActivityMyAccountProfile.this, ActivityMyAccountLogin.class);
						...
						if(customerInfo.equals("0")){
							...
							if(getIntent().hasExtra("from")) {
								...
								try {
			            			...
			            			Intent intent = new Intent(CopyOfActivityMyAccountProfile.this, callerClass);
						    	    startActivity(intent);
