...
public class Copy_2_of_ActivityMyAccountProfilenew extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		customerDOB = (TextView) findViewById(R.id.customerDOB);
  		...
  		helperQuickLinks.create(menuIcon,shoppingButton,cartButton,cartButtonNotification,Copy_2_of_ActivityMyAccountProfilenew.this,sharedPreferences);
  		...
  		if(sharedPreferences.contains("loggedIn") ) {
  			...
  			if(!sharedPreferences.contains("customerInfo") ) {
  				...
  				CUSTOMER_EMAIL = sharedPreferences.getString("customerEmail", null);
  	  		}

			new HttpAsyncTask().execute("http://www.smokesignal.co.ke/mobile_trolley_app/getcustomerinfo.php");
	       ...
	       //((TextView)customerGender.getChildAt(0)).setTextColor(color.grey333);
	       //((TextView)customerGender.getChildAt(0)).setTextColor(color.grey333); 
	       ...
	       spinner2meth(); 
    		...
    		new ApplyViewParamsTask().execute();
  			...
  			Intent intent = new Intent(Copy_2_of_ActivityMyAccountProfilenew.this, ActivityMyAccountLogin.class);
	...
	public <ViewGroup> void spinner2meth(){
		 List<String> list = new ArrayList<String>();
	        ...
	        list.add("Female");
	        list.add("Male");
		Spinner customerGender = (Spinner) findViewById(R.id.customerGender);
		ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1, list)
		{
		public View getView(int position, View convertView, android.view.ViewGroup parent) {
		tfavv = Typeface.createFromAsset(getAssets(),"fonts/ek_mukta/EkMukta-ExtraLight.ttf");
		TextView v = (TextView) super.getView(position, convertView, parent);
		//v.setTypeface(tfavv);
		v.setTypeface(tfavv, Typeface.MONOSPACE.ITALIC); 
		...
		customerGender.setAdapter(adapter1);
		}
			...
			layout_progressbar.setVisibility(View.GONE);
	  		...
	  		saveCustomerInfo.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
					...
					CUSTOMER_GENDER = customerGender.getSelectedItem().toString();
					CUSTOMER_DOB = customerDOB.getText().toString();
					
					if(CUSTOMER_FIRST_NAME == null || CUSTOMER_FIRST_NAME.isEmpty()){
                		errorMessage.setVisibility(View.VISIBLE);
                		errorMessage.setText("Fill your first name");
                		customerFname.requestFocus();
                		error = true;
                	}
                	else if(CUSTOMER_LAST_NAME == null || CUSTOMER_LAST_NAME.isEmpty()){
                		errorMessage.setVisibility(View.VISIBLE);
                		errorMessage.setText("Fill in your last name");
                		customerLname.requestFocus();
                		error = true;
                	}
                	else if(CUSTOMER_EMAIL == null || CUSTOMER_EMAIL.isEmpty()){
                		errorMessage.setVisibility(View.VISIBLE);
				...
				for(int i = 0; i < jsonArr.length(); i++){
					...
					if(querytype.equals("insert info")){
						...
						if(customerInfo.equals("0")){
							...
							JSONObject customerInfoObj = new JSONObject(customerInfo);
							String customer_fname = customerInfoObj.getString("fname");
							String customer_lname = customerInfoObj.getString("lname");
							String customer_email = customerInfoObj.getString("email");
							String customer_gender = customerInfoObj.getString("gender");
							String customer_dob = customerInfoObj.getString("dob");
							
							//Add shared preferences
							editor.putString("customerInfo","Yes");
							editor.putString("customerFirstName",customer_fname);
							...
							if(getIntent().hasExtra("from")) {
								...
								try {
			            			...
			            			Intent intent = new Intent(Copy_2_of_ActivityMyAccountProfilenew.this, callerClass);
						    	    startActivity(intent);
	...
	public static String GET(String url){
        ...
        nameValuePairs.add(new BasicNameValuePair("fname",CUSTOMER_FIRST_NAME));
	...
	public void setCurrentDate() {
		...
		/**customerDOB.setText(new StringBuilder()
