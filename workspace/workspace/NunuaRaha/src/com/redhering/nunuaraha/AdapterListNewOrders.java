...
public class AdapterListNewOrders extends BaseAdapter implements
	...
	public AdapterListNewOrders(Context ctx,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (activityName.equals("ActivityMyAccountNewOrders")) {
			...
			if (deliveryproce.equals("3")) {
					...
					holder.confirmDelivery
							.setOnClickListener(new View.OnClickListener() {
								public void onClick(View v) {
									...
									new HttpAsyncTask().execute("http://www.e-fam.com/mobile_trolley_app/confirmdelivery.php"); // call
																																// AsynTask
																																// to
																																// perform
																																// network
				...
				int imgResource = R.drawable.seen;
				...
				if (deliveryproce.equals("1")) {
					...
					int imgResource2 = R.drawable.unseen;
				...
				if (deliveryproce.equals("2")) {
					Log.i("delivery 2", " -->" + deliveryproce);
					holder.confirmDelivery.setVisibility(View.GONE);
