...
public class CopyOfActivityStep10ListPaymentOptionsGateway extends Activity {
	...
	private class ApplyViewParamsTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String params) {
			 ...
			 * 
			 * String jp_item_type = "cart"; String jp_item_name = "Nakumatt";
			 * String order_id = "455879"; String jp_business =
			 * "business@nunuaraha.com"; String jp_amount_1 = "1500"; String
			 * jp_amount_2 = "0"; String jp_amount_5 = "0"; String jp_payee =
			 * "email@yourcustomer.com"; String jp_shipping = "Yumm!"; String
			 * jp_rurl = "http://www.yourwebsite.com/testpost/Result.aspx?ii=0";
			 * String jp_furl =
			 * "http://www.yourwebsite.com/testpost/Result.aspx?ii=1"; String
			 * jp_curl = "http://www.yourwebsite.com/testpost/Result.aspx?ii=2";
			 * String image = "https://www.jambopay.com/jp_image/paynow.png";
			 * 
			 * 
			 * String postData =
			 * "jp_item_type="+jp_item_type+"&jp_item_name="+jp_item_name
			 * +"&order_id="
			 * +order_id+"&jp_business="+jp_business+"&jp_amount_1="
			 * +jp_amount_1+
			 * "&jp_amount_2="+jp_amount_2+"&jp_amount_5="+jp_amount_5
			 * +"&jp_payee="
			 * +jp_payee+"&jp_shipping="+jp_shipping+"&jp_rurl="+jp_rurl
			 * +"&jp_furl="+jp_furl+"&jp_curl="+jp_curl+"&image="+image;
			 * 
			 * 
			 * webView.postUrl(postUrl,EncodingUtils.getBytes(postData,
			 * "BASE64")); //webView.loadUrl("http://www.google.com");
			 **/
