...
public class ActivityStep06ListGoodspast extends Activity {
	...
	public static String SELECTED_BRANCH_ID2;
	...
	public static String SELECTED_OUTLET_ID2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myadapter = new AdapterSimpleList(ActivityStep06ListGoodspast.this,
	...
	private void initViews() {
		...
		int SELECTED_OUTLET_ID2 = bundle.getInt("orderOutlet2");
		int SELECTED_BRANCH_ID2 = bundle.getInt("orderbranchid");
		int SELECTED_BRAND_ID2 = bundle.getInt("orderbrandid");
		...
		helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
				cartButtonNotification, ActivityStep06ListGoodspast.this,
				sharedPreferences);
		...
		clearcart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (sharedPreferences.contains("myTrolley")) {
					...
					Toast.makeText(ActivityStep06ListGoodspast.this,
		 ...
		 * Intent(ActivityStep06ListGoods.this, ActivityStep08ListCart.class);
		 * startActivity(intent); } });
		 */
	}
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent intent = new Intent(
							ActivityStep06ListGoodspast.this,
							ActivityStep07ListreProducts.class);
	...
	public void showDialogEmptyTrolley(final String message) throws Exception {
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				Intent intent = new Intent(ActivityStep06ListGoodspast.this,
