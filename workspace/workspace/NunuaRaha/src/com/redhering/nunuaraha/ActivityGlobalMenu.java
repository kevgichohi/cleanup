...
public class ActivityGlobalMenu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		overridePendingTransition(R.anim.slide_menu_in, R.anim.slide_menu_out);// SlideIn
																				// animation
		...
		home.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ActivityGlobalMenu.this,
						ActivityMain.class);
	...
	public void onBackPressed() {
		...
		// LayoutInflater.from(getBaseContext()).inflate(R.layout.exit, null);
