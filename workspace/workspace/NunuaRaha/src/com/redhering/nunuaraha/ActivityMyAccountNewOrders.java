...
public class ActivityMyAccountNewOrders extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
				cartButtonNotification, ActivityMyAccountNewOrders.this,
				sharedPreferences);

		ImageView headerTextimage2 = (ImageView) findViewById(R.id.headerTextimage);
		headerTextimage2.setVisibility(View.VISIBLE);
		headerTextimage2.setImageResource(R.drawable.newordersactive);
		...
		clearcart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (sharedPreferences.contains("myTrolley")) {
					...
					Toast.makeText(ActivityMyAccountNewOrders.this,
		...
		if (sharedPreferences.contains("userPhoneNumber")) {
			...
			new HttpAsyncTask()
					.execute("http://www.e-fam.com/mobile_trolley_app/getmyneworders.php");

			// LIST VIEW
			MYORDERS = new ArrayList<RequestedSimpleListOrders>();
			myadapter = new AdapterListNewOrders(
					ActivityMyAccountNewOrders.this, MYORDERS,
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent intent = new Intent(ActivityMyAccountNewOrders.this,
	...
	public void onResume() {
		...
		myadapter = new AdapterListNewOrders(ActivityMyAccountNewOrders.this,
		...
		protected void onPostExecute(String params) {
			...
			rateButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					/*
					 * if(CUSTOMER_ROAD == null || CUSTOMER_ROAD.isEmpty()){
					 * errorMessage.setVisibility(View.VISIBLE);
					 * errorMessage.setText("Fill in the road near your home");
					 * road.requestFocus(); error = true; }
					 */
			...
			cancelRatingButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					// Reload page
					startActivity(new Intent(ActivityMyAccountNewOrders.this,
							ActivityMyAccountNewOrders.class));
				}
			});
	...
	public void showDialogEmptyTrolley(final String message) throws Exception {
		AlertDialog.Builder builder = new AlertDialog.Builder(
				ActivityMyAccountNewOrders.this);
