...
public class ActivityStep10ListCart extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.scroller_shoppingcartorder);
		...
		myadapter = new AdapterMyCart10(ActivityStep10ListCart.this, MYCART,
	...
	private void initViews() {
		...
		// SELECTED_Array = extras.getString("goodsIdList2");
		...
		helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
				cartButtonNotification, ActivityStep10ListCart.this,
				sharedPreferences);
		...
		clearcart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (sharedPreferences.contains("myTrolley")) {
					...
					Toast.makeText(ActivityStep10ListCart.this,
	...
	private class populateListViewTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String params) {
			...
			if (sharedPreferences.contains("myTrolley")) {
				...
				String jsonMyCartString2 = sharedPreferences.getString(
						"myTrolley", null);

				try {

					jsonMyCartObject = new JSONObject(jsonMyCartString2);
					Iterator<String> loop = jsonMyCartObject.keys();
					while (loop.hasNext()) {
						String key = loop.next();
						stockString = stockString + key + ",";

						Log.i("in clause", " -->" + stockString);
					}
				...
				String jsonMyCartString2 = extras.getString("ordersss");

				Log.i("Order", " --> " + extras.getString("ordersss"));
			...
			String total_price4 = precision.format(total_double);
			subtitle.setText("My Cart (KES." + total_price4 + ")");

			editor.putString("myTrolleyTotal", total_price4).commit();

			String Ovaraltatol = sharedPreferences.getString("myTrolleyTotal",
					null);

			Log.i("Overal Results", " --> " + TOTAL);
	...
	public void showDialogEmptyTrolley(final String message) throws Exception {
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				Intent intent = new Intent(ActivityStep10ListCart.this,
