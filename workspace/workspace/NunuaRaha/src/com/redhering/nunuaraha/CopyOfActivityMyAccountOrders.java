...
public class CopyOfActivityMyAccountOrders extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		helperQuickLinks.create(menuIcon, shoppingButton, cartButton,
				cartButtonNotification, CopyOfActivityMyAccountOrders.this,
				sharedPreferences);
		...
		if (sharedPreferences.contains("userPhoneNumber")) {
			...
			new HttpAsyncTask()
					.execute("http://www.e-fam.com/mobile_trolley_app/getmyorders.php");

			// LIST VIEW
			MYORDERS = new ArrayList<RequestedSimpleListOrders>();
			myadapter = new AdapterListOrders(
					CopyOfActivityMyAccountOrders.this, MYORDERS,
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent intent = new Intent(
							CopyOfActivityMyAccountOrders.this,
							ActivityStep09ListDeliveryOptions.class);
					startActivity(intent);
				}
			});
		} else {
			Intent intent = new Intent(CopyOfActivityMyAccountOrders.this,
	...
	public void onResume() {
		...
		myadapter = new AdapterListOrders(CopyOfActivityMyAccountOrders.this,
			...
			cancelRatingButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					startActivity(new Intent(
							CopyOfActivityMyAccountOrders.this,
							CopyOfActivityMyAccountOrders.class));
				}
			});
	...
	private class HttpAsyncRatingTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			// Reload page
			startActivity(new Intent(CopyOfActivityMyAccountOrders.this,
					CopyOfActivityMyAccountOrders.class));
		}
